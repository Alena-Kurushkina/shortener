...
import (
	...
	core "github.com/Alena-Kurushkina/shortener/internal/core"
)
...
func (m *MockStorager) DeleteRecords(ctx context.Context, deleteItems []core.DeleteItem) error {
	m.ctrl.T.Helper()
...
func (m *MockStorager) Insert(ctx context.Context, userID uuid.UUID, key, value string) error {
	m.ctrl.T.Helper()
...
func (m *MockStorager) InsertBatch(arg0 context.Context, userID uuid.UUID, batch []core.BatchElement) error {
	m.ctrl.T.Helper()
...
func (m *MockStorager) SelectStats(ctx context.Context) (*core.Stats, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SelectStats", ctx)
	ret0, _ := ret[0].(*core.Stats)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SelectStats indicates an expected call of SelectStats.
func (mr *MockStoragerMockRecorder) SelectStats(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SelectStats", reflect.TypeOf((*MockStorager)(nil).SelectStats), ctx)
}

// SelectUserAll mocks base method.
func (m *MockStorager) SelectUserAll(ctx context.Context, userID uuid.UUID) ([]core.BatchElement, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SelectUserAll", ctx, userID)
	ret0, _ := ret[0].([]core.BatchElement)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
