...
func newFileRepository(filename string) (db core.Storager, err error) {
...
func (r FileRepository) InsertBatch(_ context.Context, userID uuid.UUID, batch []core.BatchElement) (err error) {
	// open file
...
func (r FileRepository) SelectUserAll(ctx context.Context, id uuid.UUID) ([]core.BatchElement, error) {
	return []core.BatchElement{}, nil
}

// DeleteRecords deletes data from storage.
func (r FileRepository) DeleteRecords(ctx context.Context, deletedItems []core.DeleteItem) error {
	return nil
}

func (r FileRepository) SelectStats(ctx context.Context) (stats *core.Stats, err error) {
	return nil, nil
}
